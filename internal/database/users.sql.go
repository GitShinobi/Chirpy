...
const updateChirpyRedMembership = `-- name: UpdateChirpyRedMembership :exec
UPDATE users SET is_chirpy_red = True WHERE id = $1
`

func (q *Queries) UpdateChirpyRedMembership(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, updateChirpyRedMembership, id)
	return err
}
